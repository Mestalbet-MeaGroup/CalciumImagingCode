function [AdMat,ids]=CalcPlotSchematicInteraction(fr,ic,traces)
% Calculates and plots a schematic of interaction based on lags with the
...
% [dfTraces,time]  = CalcDf_f(intensitymat,1/mean(diff(rawTime)),rawTime);
% for i=1:size(ic,2)
