...
%            sensitivity, expect more clusters; with a lower
%            sensitivity, fewer clusters. (DEFAULT: 0.2;
...
% Columnwise clustering is now done. Let's cluster the
% data based on the columnwise clusterBounds:
