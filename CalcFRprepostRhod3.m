function CalcFRprepostRhod3(DataSet)
...
tPresRhod3 = DataSet{2}.tRhod3;
icPresRhod3 = DataSet{2}.icRhod3;

tPostsBase = DataSet{1}.tBase;
icPostsBase = DataSet{1}.icBase;
tPostsRhod3 = DataSet{1}.tRhod3;
icPostsRhod3 = DataSet{1}.icRhod3;
...
for i=1:size(icPresRhod3,2)
    %     if i==4
    %         [tPresRhod3{4},icPresRhod3{4}] = removeNeuronsWithoutPrompt(tPresRhod3{4},icPresRhod3{4},[220;1],[246;1]);
    %     end
    ...
    function PlotPrePost(tpre,icpre,tpost,icpost)
        ...
        %% Calculate Index
        if (length(tpre)>100)&&(length(tpost)>100)
            ...
            postIndex=(startpost:stoppost);
            preIndex=(startpre:stoppre);
            preIndex=preIndex-postIndex(1);
            preIndex=preIndex+min(abs(preIndex));
            postIndex=postIndex-postIndex(1);
        end
